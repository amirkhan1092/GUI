...
var = IntVar();
w1 = Radiobutton(root, text="OPTION1:SUB MENU", fg="red", bg="black", font=("calibri", 29), relief="sunken",
                 variable=var, value=1, command=f)
w1.pack(anchor=W, padx=10)
w2 = Radiobutton(root, text="OPTION2:AMERICAN CHOPSE", fg="red", bg="black", font=("calibri", 19), relief="sunken",
                 variable=var, value=2, command=f)
w2.pack(anchor=W, padx=10)
w2 = Radiobutton(root, text="OPTION3:ALLO PATTISE", fg="red", bg="black", font=("calibri", 19), relief="sunken",
                 variable=var, value=3, command=f)
w2.pack(anchor=W, padx=10)
w2 = Radiobutton(root, text="OPTION4:CHILLI PANEER", fg="red", bg="black", font=("calibri", 19), relief="sunken",
                 variable=var, value=4, command=f)
w2.pack(anchor=W, padx=10)
w2 = Radiobutton(text="OPTION5:SCHEZWAN NOODLES", fg="red", bg="black", font=("calibri", 19), relief="sunken",
                 variable=var, value=5, command=f)
w2.pack(anchor=W, padx=10)
label = Label(root)
label.pack()
# ------------------------------------entry widget----------------------------------#
...
bt1 = Button(f2, text="1", padx=16, bd=8, fg="black", bg="powder blue", command=lambda: btnClick(1),
             font=("arial", 20, "bold")).grid(row=1, column=0)
bt1 = Button(f2, text="2", padx=16, bd=8, fg="black", bg="powder blue", command=lambda: btnClick(2),
             font=("arial", 20, "bold")).grid(row=1, column=1)
bt1 = Button(f2, text="3", padx=16, bd=8, fg="black", bg="powder blue", command=lambda: btnClick(3),
             font=("arial", 20, "bold")).grid(row=1, column=2)
bt1 = Button(f2, text="+", padx=16, bd=8, fg="black", bg="powder blue", command=lambda: btnClick("+"),
             font=("arial", 20, "bold")).grid(row=1, column=3)

bt1 = Button(f2, text="4", padx=16, bd=8, fg="black", bg="powder blue", command=lambda: btnClick(4),
             font=("arial", 20, "bold")).grid(row=2, column=0)
bt1 = Button(f2, text="5", padx=16, bd=8, fg="black", bg="powder blue", command=lambda: btnClick(5),
             font=("arial", 20, "bold")).grid(row=2, column=1)
bt1 = Button(f2, text="6", padx=16, bd=8, fg="black", bg="powder blue", command=lambda: btnClick(6),
             font=("arial", 20, "bold")).grid(row=2, column=2)
bt1 = Button(f2, text="-", padx=16, bd=8, fg="black", bg="powder blue", command=lambda: btnClick("-"),
             font=("arial", 20, "bold")).grid(row=2, column=3)

bt1 = Button(f2, text="7", padx=16, bd=8, fg="black", bg="powder blue", command=lambda: btnClick(7),
             font=("arial", 20, "bold")).grid(row=3, column=0)
bt1 = Button(f2, text="8", padx=16, bd=8, fg="black", bg="powder blue", command=lambda: btnClick(8),
             font=("arial", 20, "bold")).grid(row=3, column=1)
bt1 = Button(f2, text="9", padx=16, bd=8, fg="black", bg="powder blue", command=lambda: btnClick(9),
             font=("arial", 20, "bold")).grid(row=3, column=2)
bt1 = Button(f2, text="*", padx=16, bd=8, fg="black", bg="powder blue", command=lambda: btnClick("*"),
             font=("arial", 20, "bold")).grid(row=3, column=3)

bt1 = Button(f2, text="0", padx=16, bd=8, fg="black", bg="powder blue", command=lambda: btnClick(0),
             font=("arial", 20, "bold")).grid(row=4, column=0)
bt1 = Button(f2, text="C", padx=16, bd=8, fg="black", bg="powder blue", command=lambda: btnClear("C"),
             font=("arial", 20, "bold")).grid(row=4, column=1)
bt1 = Button(f2, text="=", padx=16, bd=8, fg="black", bg="powder blue", command=lambda: btnEquals("="),
             font=("arial", 20, "bold")).grid(row=4, column=2)
bt1 = Button(f2, text="/", padx=16, bd=8, fg="black", bg="powder blue", command=lambda: btnClick("/"),
